...
class DocClassificationRest(nn.Module):
    def __init__(self, args, pretrained_densenet121, pretrained_holistic):
        super(DocClassificationRest, self).__init__()
        self.pretrained_densenet121 = pretrained_densenet121
    ...
    def forward(self, batch_holistic, batch_header, batch_footer, batch_left_body, batch_right_body):
        output_holistic = torch.softmax(self.pretrained_densenet121(batch_holistic), dim=1)

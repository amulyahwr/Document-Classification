...
#         print('test_rest_multiple_loss')
    ...
    def train_ensemble(self, batch_holistic, batch_header, batch_footer, batch_left_body, batch_right_body, labels):
        self.model.train()
        self.optimizer.zero_grad()
    ...
    # helper function for testing
    def test_ensemble(self, batch_holistic, batch_header, batch_footer, batch_left_body, batch_right_body, labels):
        with torch.no_grad():
            self.model.eval()
